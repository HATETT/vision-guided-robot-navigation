...
from src.vision_guided_robot_navigation.devices.base import (
    ConnectionError,
    DeviceError,
    CellRobot, 
)
...
if __name__ == "__main__":
    def main():
        ...
        test = loading_robot.set_PR(1, 2, 2 ,2)
        print(test.poseRegisterData.cartData.position.x,
              test.poseRegisterData.cartData.position.y,
              test.poseRegisterData.cartData.position.z)
